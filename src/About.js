...
export default function About() {
  return <div>
    ...
    <div id="aboutPDiv">
      ...
      <p><i class="fas fa-globe"></i> My native language it's Portuguese, I'm an English intermediary speaker, Spanish beginner speaker and I'm studying German by myself.</p>
